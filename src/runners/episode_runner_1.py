...
class EpisodeRunner:
    ...
    def run(self, test_mode=False):
        ...
        while not terminated:
            ...
            actions,sample_prob = self.mac.select_actions(self.batch, t_ep=self.t, t_env=self.t_env, test_mode=test_mode)
        ...
        self.batch.update({"actions": actions,
                           "actions_prob":sample_prob,}, ts=self.t)
